...
Las instrucciones de carga desde cero están en el [README principal](../README.md). Documento en el README principal las consultas y capturas de pgAdmin que confirman conteos, limpieza, conciliación, fechas, pedidos mensuales, trazabilidad y tipos. No se conservan evidencias del enfoque descartado. El dataset está publicado con autorización del usuario para incluir nombres y CUIT de la fuente pública (21/09/2026).

## Alcance de la entrega

El modelo está cargado y validado. Documento el top 5, la evolución mensual y los combustibles líquidos menos vendidos con sus resultados e interpretaciones en el README principal. También documento el ranking de pedidos por categoría con su captura e interpretación. Documento también la concentración del top 5, con una participación del 55,16 % del importe total. Documento el precio ponderado por producto y mes con su resultado completo en `../resultados/precios_ponderados_mensuales.csv`: 83 combinaciones, sin registros de nafta común en octubre. Presento las conclusiones globales y los límites de interpretación en el README principal.
