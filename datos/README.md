...
El modelo está cargado y validado. Documento el top 5, la evolución mensual y los combustibles líquidos menos vendidos con sus resultados e interpretaciones en el README principal. También documento el ranking de pedidos por categoría con su captura e interpretación. Documento también la concentración del top 5, con una participación del 55,16 % del importe total. La sexta consulta, precio ponderado por producto y mes, está preparada y pendiente de resultado. Las conclusiones globales están en desarrollo.
