...
El modelo está cargado y validado. Documento el top 5, la evolución mensual y los combustibles líquidos menos vendidos con sus resultados e interpretaciones en el README principal. También documento el ranking de pedidos por categoría con su captura e interpretación. La quinta consulta, sobre concentración del top 5, está preparada y pendiente de resultado. El precio ponderado por producto y mes y las conclusiones globales están en desarrollo.
